...
class Community(object):
    ...
    def updateNodedWeight(self, edgeweights):
                ...
                if j != i:
                    ...
                    if j in Graph[i]:
                        if similarity_matrix_type == 'cosine':
                            ...
                            g = 0
                        break
                    sim = alpha * g + (1 - alpha) * float(similarity_matrix[i][j])
                    sim_i.append((sim, j))
    ...
    def get_communities(self, Graph, similarity_matrix, similarity_matrix_type='cosine'):
        try:
            #List of Vertices
    ...
    def view_communities(self, communities, knngraph):
        try:
            ...
            nx.draw_networkx_edges(knng, pos, edgelist=red_edges, edge_color='r', arrows=True)
